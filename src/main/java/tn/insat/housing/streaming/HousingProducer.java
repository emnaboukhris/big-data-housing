...
public class HousingProducer {

    public static void main(String[] args) throws Exception{

        // Verifier que le topic est donne en argument
        if(args.length < 2){
            System.out.println("Entrer le nom du topic and he name of the csv file");
            return;
        }
        ...
        // Definr un acquittement pour les requetes du producteur
        props.put("acks", "all");
        ...
        Producer<String, String> producer = new KafkaProducer
                <String, String>(props);
        String csvFile = args[1].toString();
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                producer.send(new ProducerRecord<String, String>(topicName, data[0], line));
            }
            System.out.println("Messages envoyes avec succes");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            if (br != null) {
